<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <body>
        <div class="container-custom">
            ...
            <div class="info-box">
                <strong>ℹ️ À propos des tokens :</strong> Les tokens sont des identifiants uniques avec une date
                d'expiration.
            ...
            <div class="action-section">
                ...
                <div class="generate-form">
                    ...
                    <input type="number" id="expiration_minutes" class="form-control" style="max-width: 120px;"
                        value="60" min="1">
                    <span>minutes</span>
            ...
            <div class="action-section">
                ...
                <button class="btn btn-warning" onclick="cleanupExpiredTokens()">Supprimer tous les tokens
                    expirés</button>
